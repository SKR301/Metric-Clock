class Util{
    ...
    static checkInputDateFormat(date){
        if(!date.match(/[0-9]{3}-[0-9]{2}-[0-9]{4}/)){
            return false;
        }

        const element = date.split('-');
        if(Number(element[0]) > 100){
            return false;
        }
        if(Number(element[1]) > 10){
            return false;
        }
    ...
    static checkInputTimeFormat(time){
        if(!time.match(/[0-9]{2}:[0-9]{2}:[0-9]{2}/)){
            return false;
        }

        const element = time.split(':');
        if(Number(element[0]) > 9){
            return false;
        }
        if(Number(element[1]) > 99){
            return false;
        }
        if(Number(element[2]) > 99){
            return false;
        }
