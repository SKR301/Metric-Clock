class Display{
    ...
    static now(format = 'Time: %Hh:%Mm:%Ss\nDate: %dd/%mm/%yy'){
        ...
        mYear = this.addPadding(mYear,4);mMonth = this.addPadding(mMonth,2);mDay = this.addPadding(mDay,3);
        mHour = this.addPadding(mHour,2);mMin = this.addPadding(mMin,2);mSec = this.addPadding(mSec,2);
